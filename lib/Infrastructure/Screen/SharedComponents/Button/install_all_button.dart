...
class InstallAllButton extends StatelessWidget {
  InstallAllButton({super.key, required this.handle, required this.isActive});
          ...
          : () {
              showDialog(
                  ...
                  builder: (context) => AlertDialog(
                        ...
                        content: Text(
                            '${LocalizationApi().tr('do_you_confirm_installation_of_all')} ?'),
                      ));
            },
      label: Text(LocalizationApi().tr('install_all'),
